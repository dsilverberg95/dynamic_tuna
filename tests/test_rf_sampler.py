import unittest
import optuna
from dynamic_tuna.samplers import RandomForestSampler

class TestRandomForestSampler(unittest.TestCase):
    def test_xi_dynamic_adjustment(self):
        def xi_function(n):
            return 0.05 * n

        sampler = RandomForestSampler(xi_function=xi_function)
